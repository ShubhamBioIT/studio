  ...
  async function handleGoogleSignIn() {
    ...
    try {
        ...
        if (error.code === 'auth/popup-closed-by-user') {
            description = 'The sign-in popup was closed before completing. This can happen if the application\'s domain is not authorized in your Firebase project. Please go to your Firebase Console -> Authentication -> Settings -> Authorized domains, and ensure the domain from your browser\'s address bar is listed. If it is, please try again.';
